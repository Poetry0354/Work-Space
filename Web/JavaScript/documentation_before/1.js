...
/*El switch es como algo que nos permite hacer acciones segun un caso en especifico.
Es como el if-else pero mas sencillo.
Ya que funciona en un bloque No tenemos que escribir varios if y else para eso.
*/
